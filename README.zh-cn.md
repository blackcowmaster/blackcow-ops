...
- **[FableCodex](https://github.com/baskduf/FableCodex)** — Findings Gate 模式。
- **[superpowers-reasonix](https://github.com/christopherarter/superpowers-reasonix)** — 根因优先诊断纪律。
- **[fablize](https://github.com/fivetaku/fablize)** — 诚实限制哲学。
