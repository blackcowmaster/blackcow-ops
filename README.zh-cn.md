<div align="center">
  <h1>BlackCow Ops</h1>
  <p><strong>为 Reasonix + DeepSeek 打造的 9 个自我改进工作流技能。</strong></p>
  <p>
...
BlackCow Ops 是一套 9 个 Reasonix 技能，构成编码任务的 **govern → plan → execute → verify → evolve** 流水线。强制执行 BKIT 11 门质量体系，并针对 DeepSeek 的成本优势进行了优化。修复拼写错误约 $0.001，多文件功能约 $0.03。
...
| `blackcow-app-scraper` | App Store + Play Store 评论抓取。提取元数据、评论和相似应用 — 无需 API 密钥。 |
| `blackcow-app-intel` | 从抓取的评论中获取市场情报。情感分析、投诉排名、弱点地图、PRD 见解。 |
